...
module.exports = (stock) => {
    ...
    return {
        ...
        stock_screener: ({limit,exchange } = {}) => makeRequest('stock-screener', generateJson(stock, {limit:limit,exchange:exchange})),

        recent_history: ({ time_range } = {}) => makeRequest('historical-chart/'+time_range, generateJson(stock)),
